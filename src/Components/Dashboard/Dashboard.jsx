...
useEffect(() => {
  ...
  <div className="w-[250px] md:w-[180px] lg:w-[250px] rounded-[8px] bg-white">
  ...
  <div className="w-[250px] md:w-[180px] lg:w-[250px] rounded-[8px]  py-[10px] bg-white">
...
<div className="flex mt-[30px] gap-[30px] ml-[50px] lg:ml-[170px]">
