...
const ProjectTaskPage = () => {
  ...
  console.log(addIcon);
  console.log("showSunTask", showSubTask);
  const { id } = useParams();
  ...
  return (
    <div className="w-full">
      ...
      <div className="text-center text-xl font-bold space-y-1">
              ...
              <tr className="font-medium">
                ...
                <td>
                  <div className="">
                    ...
                    >
                      <span onChange={() => setUpdateId(info.id)}>Update</span>
                    </button>
                ...
                <td>
                  <div className="">
                    {info?.is_complete === false && info?.is_active === true ? (
                      <button
