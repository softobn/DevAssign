    ...
    </thead>
   {
    projectinfo.map((item,index) =>  <tbody>
        ...
        <tr className=" text-[18px] text-center">
          ...
          {
            item.is_complete === true  ? <td className="border-y-2 "><span className="bg-red-400  text-white font-bold px-[5px] py-[4px]">Lately</span></td>  :  <td className="border-y-2"><span className="bg-lime-500  text-white font-bold px-[5px] py-[4px]">Ongoing</span></td>
          }
