    ...
    </thead>
   {
    projectinfo.map((item,index) =>  <tbody>
        ...
        <tr className=" text-[18px] text-center">
          ...
          {
            item.is_complete === true ? <td className="border-2"><span className="bg-lime-400  text-white font-bold px-[5px] py-[4px]">Done</span></td> : <td className="border-2"><span className="bg-blue-500  text-white font-bold px-[5px] py-[4px]">Due</span></td>
          }
