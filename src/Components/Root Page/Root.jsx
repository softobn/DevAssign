      ...
      <div className="bg-blue-500 md:w-[350px] lg:w-[250px]  md:h-[1000px] ">
        <div className="flex pt-[20px]">
          <img
            ...
            src="https://i.ibb.co/288YtK5/1245850.png"
            alt=""
          />
          <h1 className="text-center text-[28px] text-white font-bold">
            Dev<span className="text-blue-900">Assign</span>
          </h1>
        </div>

        <div className="relative top-[40px] ">
          <img
            className="h-[100px] w-[100px] rounded-[50%] mx-auto"
        ...
        <Link to={"/dashboard"}>
          <div
            className="focus:border-l-[10px] border-blue-950 mt-[80px] "
            tabIndex="0"
          >
            <MdSpaceDashboard className="text-[35px] mx-auto"></MdSpaceDashboard>
            <h1 className="text-[30px] text-white font-semibold text-center">
              Dashboard
            </h1>
          </div>
        </Link>
        ...
        <div
          className="focus:border-l-[10px] border-blue-950 mt-[30px]"
          tabIndex="0"
        >
